...
<template>
  <div class="main">
    ...
    <PureTableBar title="部门管理" :columns="columns" :tableRef="tableRef?.getTableRef()" @refresh="onSearch" @fullscreen="onFullscreen">
      <template #buttons>
      ...
      <template v-slot="{ size, dynamicColumns }">
        ...
        >
          <template #operation="{ row }">
            ...
            <el-button class="reset-margin" link type="primary" :size="size" :icon="useRenderIcon(AddFill)" @click="openDialog('新增', { parentId: row.id } as any)">
              新增
            </el-button>
